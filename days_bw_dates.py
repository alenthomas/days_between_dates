...
if __name__ == "__main__":
    print("no of days: ", days_bw_dates(5, 5, 2017, 14, 6, 2017))
    print("no of days: ", days_bw_dates(23, 4, 2017, 24, 8, 2017))
    print("no of days: ", days_bw_dates(26, 8, 1993, 11, 1, 2021))
    #print("no of days: ", days_bw_dates(d1, m1, y1, d2, m2, y2))
    print("no of days: ", days_bw_dates())
